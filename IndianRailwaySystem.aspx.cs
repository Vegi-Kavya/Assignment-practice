...
{
    public partial class IndianRailwaySystem : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                SqlDataAdapter SDA = new SqlDataAdapter("select * from IndianRailwaySystem", con);//to retrieve data from database-student
